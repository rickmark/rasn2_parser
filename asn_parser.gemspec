...
Gem::Specification.new do |s|
  ...
  s.extensions = File.join(*%w(ext asn_parser extconf.rb))

  s.require_path = 'lib'
  s.files = Dir[
    '{lib,spec}/**/*',
    'ext/asn_parser/*.{cpp,h}',
    'ext/asn_parser/extconf.rb',
    'ext/asn_parser/antlrgen/*',
    'ext/asn_parser/antlr4-upstream/runtime/Cpp/runtime/src/**/*.{cpp,h}',
    'Gemfile',
    'README.md',
    'Rakefile',
    'asn_parser.gemspec'
